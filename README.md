...
rclone --config ~/.rclone/rclone-archives-readonly.config rcd --rc-allow-origin "\*" --rc-user='local' --rc-pass="1234" --rc-serve

rclone --config ~/.rclone/rclone-archives-readonly.config rcd --rc-web-gui
